...
//wjy add
    vector<double> getMoveChange(Instance *ins, int nx, int ny);
    int calMhatton(int x1,int y1,int x2,int y2);

//shj add
    vector<Instance*> searchTimingInst(Instance *a);
    bool isIndependent(vector<pair<Instance *,Instance *>> independentSet);
    ...
    //shj add
    void swapLUT6withLUT6(Instance* lut6a,Instance* lut6b);
    void swapLUT6withNLUT6(Instance* lut6,Instance* nlut6a,Instance* nlut6b);
    int calLUT6wNLUT6Cost(Instance *lut6,Instance *nlut6a,Instance *nlut6b);
